<template>
    <app-layout>
        ...
        <div v-if="!sales.length" class="m-2">
            <div class="flex max-w-sm mb-4 bg-yellow-200 border rounded dark:bg-yellow-600">
                ...
                <div class="items-center w-auto p-4 text-grey-darker">
                    <span class="pb-4 text-lg font-semibold"> برجاء الإنتباه ! </span>
                    <p class="leading-tight">
                        لا توجد اى عمليات بيع/شراء
                    </p>
                </div>
            </div>
        </div>
